...
export default class MyDatePicker extends Component {
    ...
    daysMap = ['Chủ nhật', 'Thứ hai', 'Thứ ba', 'Thứ tư', 'Thứ năm', 'Thứ sáu', 'Thứ bảy'];
    // daysMap = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thurday', 'Friday', 'Saturday'];
    // daysMap = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];
    // monthMap = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
    monthMap = ['Tháng 1', 'Tháng 2', 'Tháng 3', 'Tháng 4', 'Tháng 5', 'Tháng 6', 'Tháng 7', 'Tháng 8', 'Tháng 9', 'Tháng 10', 'Tháng 11', 'Tháng 12'];
        ...
        return (
            <div className='c-container'>
                <div className='cc-head'>
                    {['CN', 'HAI', 'BA', 'TƯ', 'NĂM', 'SÁU', 'BẢY'].map((d,i)=><div key={i} className='cch-name'>{d}</div>)}
                </div>
